...
import { GetRandomBytes } from './encryption/cryptoRandom';
 ...
 * @ignore
 */
export declare function getLegacyAppNode(appsNode: string | BIP32Interface, salt: string, appDomain: string): BIP32Interface;
/**
...
export declare class BlockstackWallet {
     ...
     * @ignore
     */
    static fromEncryptedMnemonic(data: string | Buffer, password: string, triplesecDecrypt: TriplesecDecryptSignature): Promise<BlockstackWallet>;
    /**
     ...
     *
     */
    static encryptMnemonic(mnemonic: string, password: string, opts?: {
        getRandomBytes?: GetRandomBytes;
    }): Promise<string>;
    getIdentityPrivateKeychain(): BIP32Interface;
    getBitcoinPrivateKeychain(): BIP32Interface;
    getBitcoinNode(addressIndex: number, chainType?: string): BIP32Interface;
    ...
    static getNodeFromBitcoinKeychain(keychainBase58: string, addressIndex: number, chainType?: string): BIP32Interface;
    /**
    ...
    static getAddressFromBIP32Node(node: BIP32Interface): string;
    /**
     * Get a ECDSA private key hex-string for an application-specific
     *  address.
     * @param {String} appsNodeKey - the base58-encoded private key for

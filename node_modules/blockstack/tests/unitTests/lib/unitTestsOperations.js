...
function networkTests() {
  (0, _tape2.default)('insight-client', function (t) {
    ...
    _fetchMock2.default.get('https://explorer-api.blockstack.org/api/v2/fee-estimate', { recommended: 1000 });
  ...
  (0, _tape2.default)('use alternative magic bytes', function (t) {
    ...
    Promise.resolve().then(function () {
      ...
      for (var i = 0; i < txs.length; i++) {
        ...
        t.equal(_network.network.defaults.MAINNET_DEFAULT.MAGIC_BYTES, 'di');
        t.equal(Buffer.from(nullOut).toString().substring(2, 4), 'di');
      }
    }).then(function () {
      _network.network.defaults.MAINNET_DEFAULT.MAGIC_BYTES = 'id';
    });
  });

...
var _proxyquire18 = require('proxyquire');

var _proxyquire19 = _interopRequireDefault(_proxyquire18);
...
function runStorageTests() {
  (0, _tape2.default)('getFile unencrypted, unsigned', function (t) {
    ...
    var _proxyquire = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
  ...
  (0, _tape2.default)('getFile unencrypted, unsigned - multi-reader', function (t) {
    ...
    var _proxyquire2 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
  ...
  (0, _tape2.default)('putFile unencrypted, not signed', function (t) {
    ...
    var _proxyquire3 = (0, _proxyquire19.default)('../../../lib/storage', {
  ...
  (0, _tape2.default)('putFile & getFile unencrypted, not signed, with contentType', function (t) {
    ...
    var _proxyquire4 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire4.putFile;

    var _proxyquire5 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl }
    }),
  ...
  (0, _tape2.default)('putFile & getFile encrypted, not signed', function (t) {
    ...
    var _proxyquire6 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire6.putFile;

    var _proxyquire7 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl }
    }),
  ...
  (0, _tape2.default)('putFile encrypt/no-sign using specifying public key & getFile decrypt', function (t) {
    ...
    var _proxyquire8 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire8.putFile;

    var _proxyquire9 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl }
    }),
  ...
  (0, _tape2.default)('putFile & getFile encrypted, signed', function (t) {
    ...
    var _proxyquire10 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire10.putFile;

    var _proxyquire11 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl },
  ...
  (0, _tape2.default)('putFile & getFile unencrypted, signed', function (t) {
    ...
    var _proxyquire12 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, uploadToGaiaHub: uploadToGaiaHub }
    }),
        putFile = _proxyquire12.putFile;

    var _proxyquire13 = (0, _proxyquire19.default)('../../../lib/storage', { // eslint-disable-line no-shadow
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection, getFullReadUrl: getFullReadUrl },
      '../profiles': { lookupProfile: lookupProfile }
    }),
  ...
  (0, _tape2.default)('promises reject', function (t) {
    ...
    var getOrSetLocalGaiaHubConnection = _sinon2.default.stub().resolves(gaiaHubConfig);
    var setLocalGaiaHubConnection = _sinon2.default.stub().resolves(gaiaHubConfig);

    var _proxyquire14 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': {
        getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection,
        setLocalGaiaHubConnection: setLocalGaiaHubConnection
      }
    }),
  ...
  (0, _tape2.default)('putFile gets a new gaia config and tries again', function (t) {
    t.plan(3);
    var path = 'file.json';
    var fullWriteUrl = 'https://hub.testblockstack.org/store/1NZNxhoxobqwsNvTb16pdeiqvFvce3Yabc/file.json';
    var invalidHubConfig = {
    ...
    var validHubConfig = Object.assign({}, invalidHubConfig, {
      token: 'valid'
    });

    var getOrSetLocalGaiaHubConnection = _sinon2.default.stub().resolves(invalidHubConfig);
    var setLocalGaiaHubConnection = _sinon2.default.stub().resolves(validHubConfig);

    var _proxyquire15 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': {
        getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection,
        setLocalGaiaHubConnection: setLocalGaiaHubConnection
      }
    }),
        putFile = _proxyquire15.putFile;

    _fetchMock2.default.post(fullWriteUrl, function (url, _ref3) {
    ...
    putFile(path, 'hello world', { encrypt: false }).then(function () {
      return t.ok(true, 'Request should pass');
    });
  });
  ...
  (0, _tape2.default)('getUserAppFileUrl', function (t) {
    ...
    var _proxyquire16 = (0, _proxyquire19.default)('../../../lib/storage', {
      '../profiles': { lookupProfile: lookupProfile }
    }),
        getUserAppFileUrl = _proxyquire16.getUserAppFileUrl;
  ...
  (0, _tape2.default)('listFiles', function (t) {
    ...
    var _proxyquire17 = (0, _proxyquire19.default)('../../../lib/storage', {
      './hub': { getOrSetLocalGaiaHubConnection: getOrSetLocalGaiaHubConnection }
    }),
        listFiles = _proxyquire17.listFiles;

  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">74.87% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>280/374</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">67.04% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>179/267</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>275/369</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1022'></a><a href='#L1022'>1022</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export async function encryptContent(
  ...
  if (!opts.publicKey) {
    privateKey = (caller || <span class="branch-1 cbranch-no" title="branch not covered" >new UserSession())</span>.loadUserData().appPrivateKey
...
export function decryptContent(
  ...
  const opts = Object.assign({}, options)
  if (!opts.privateKey) {
    opts.privateKey = (caller || <span class="branch-1 cbranch-no" title="branch not covered" >new UserSession())</span>.loadUserData().appPrivateKey
  }
&nbsp;
  try {
...
function normalizeOptions&lt;T&gt;(
  ...
  if (opts.username) {
    if (!opts.app) {
      caller = caller || <span class="branch-1 cbranch-no" title="branch not covered" >new UserSession()</span>
...
&nbsp;
  ...
  if (opts.username) {
    ...
    const gaiaHubConfig = await (caller || <span class="branch-1 cbranch-no" title="branch not covered" >new UserSession())</span>.getOrSetLocalGaiaHubConnection()
...
<span class="cstat-no" title="statement not covered" >    etags[path] = etag</span>
  }
 ...
 * @ignore
 */
async function <span class="fstat-no" title="function not covered" >handleSignedEncryptedContents(</span>caller: UserSession, path: string, 
                                             storedContents: string, app: string, 
                                             privateKey?: string, username?: string, 
                                             zoneFileLookupURL?: string
): Promise&lt;string | Buffer&gt; {
  const appPrivateKey = <span class="cstat-no" title="statement not covered" >privateKey || caller.loadUserData().appPrivateKey</span>
&nbsp;
  const appPublicKey = <span class="cstat-no" title="statement not covered" >getPublicKeyFromPrivate(appPrivateKey)</span>
&nbsp;
  let address: string
<span class="cstat-no" title="statement not covered" >  if (username) {</span>
<span class="cstat-no" title="statement not covered" >    address = await getGaiaAddress(app, username, zoneFileLookupURL, caller)</span>
  } else {
<span class="cstat-no" title="statement not covered" >    address = publicKeyToAddress(appPublicKey)</span>
  }
...
<span class="cstat-no" title="statement not covered" >    sigObject = JSON.parse(storedContents)</span>
  } catch (err) {
<span class="cstat-no" title="statement not covered" >    if (err instanceof SyntaxError) {</span>
...
<span class="cstat-no" title="statement not covered" >      throw err</span>
  ...
  const signature = <span class="cstat-no" title="statement not covered" >sigObject.signature</span>
  const signerPublicKey = <span class="cstat-no" title="statement not covered" >sigObject.publicKey</span>
  const cipherText = <span class="cstat-no" title="statement not covered" >sigObject.cipherText</span>
  const signerAddress = <span class="cstat-no" title="statement not covered" >publicKeyToAddress(signerPublicKey)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!signerPublicKey || !cipherText || !signature) {</span>
<span class="cstat-no" title="statement not covered" >    throw new SignatureVerificationError(</span>
  ...
  } else <span class="cstat-no" title="statement not covered" >if (signerAddress !== address) {</span>
<span class="cstat-no" title="statement not covered" >    throw new SignatureVerificationError(`Signer pubkey address (${signerAddress}) doesn't`</span>
                                          + ` match gaia address (${address})`)
  } else <span class="cstat-no" title="statement not covered" >if (!verifyECDSA(cipherText, signerPublicKey, signature)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new SignatureVerificationError('Contents do not match ECDSA signature in file:'</span>
                                          + ` ${path}`)
  } else <span class="cstat-no" title="statement not covered" >if (typeof (privateKey) === 'string') {</span>
...
<span class="cstat-no" title="statement not covered" >    return caller.decryptContent(cipherText)</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Expected to get back a string for the cipherText')</span>
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (opt.decrypt &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >opt.verify)</span> {
<span class="cstat-no" title="statement not covered" >    if (typeof storedContents !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Expected to get back a string for the cipherText')</span>
    }
    let decryptionKey
<span class="cstat-no" title="statement not covered" >    if (typeof (opt.decrypt) === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      decryptionKey = opt.decrypt</span>
    }
<span class="cstat-no" title="statement not covered" >    return handleSignedEncryptedContents(caller, path, storedContents,</span>
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to determine byte length with charset: ${contentType}`)</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof TextEncoder !== 'undefined') {
          const encodedString = <span class="cstat-no" title="statement not covered" >new TextEncoder().encode(content)</span>
<span class="cstat-no" title="statement not covered" >          return Buffer.from(encodedString.buffer)</span>
        }
...
<span class="cstat-no" title="statement not covered" >        etags[path] = writeResponse.etag</span>
      }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Mar 25 2020 15:10:42 GMT-0400 (Eastern Daylight Time)
</div>
</div>

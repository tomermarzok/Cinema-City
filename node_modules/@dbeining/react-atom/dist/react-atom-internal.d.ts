...
import { HookDependencies, PublicExports, UseAtomOptions } from "./internal-types";
/**
 ...
 * ```
 */
export declare function initialize(hooks: HookDependencies): PublicExports;
/**
 ...
 * ```
 */
export declare function useAtom<S>(atom: Atom<S>): DeepImmutable<S>;
/**
 * #### **Important:** _`useAtom` is a React Hook and must follow the [Rules of Hooks](https://github.com/reactjs/reactjs.org/blob/f203cd5d86c4c611a31a4f72c5a91e2db0858ce3/content/docs/hooks-rules.md)_
 *
 ...
 *```
 */
export declare function useAtom<S, R>(atom: Atom<S>, options: UseAtomOptions<S, R>): DeepImmutable<R>;
